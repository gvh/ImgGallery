...
class StopWords {
    static let list: Set<String> = ["a", "about", "across", "after", "afterwards", "again", "against", "all", "alone", "along",
                                    "already", "also", "although", "always", "am", "among", "amongst", "amoungst", "amount", "an",
                                     ...
                                     "as", "at", "be", "became", "because", "become", "becomes", "becoming", "been", "beforehand", "behind",
                                     ...
                                     "detail", "do", "done", "due", "during", "each", "eg", "eight", "either", "eleven", "else",
                                     "elsewhere", "empty", "enough", "etc", "even", "ever", "every", "except", "few", "fifteen",
                                     "fify", "fill", "find", "fire", "first", "five", "for", "former", "formerly", "forty", "found",
                                     "four", "from", "full", "further", "get", "give", "go", "had", "has", "hasnt", "have", "he", "hence",
                                     "her", "here", "hereafter", "hereby", "herein", "hereupon", "hers", "herself", "him", "himself", "his",
                                     "how", "however", "hundred", "ie", "if", "in", "inc", "indeed", "interest", "into", "is",
                                     "it", "its", "itself", "keep", "last", "latter", "latterly", "least", "less", "ltd", "made",
                                     ...
                                     "next", "nine", "no", "nobody", "none", "noone", "nor", "not", "now", "nowhere", "of", "off",
    ...
    static func isStopWord(word: String) -> Bool {
        return StopWords.list.contains(word)
    }
}
